...
from NBAtrfastbk.items import NBAtrfastbk_Item

class NBAtrfastbk(Spider):
	name = 'NBAtrfastbk_spider'
	allowed_urls = ['www.teamrankings.com/']
	start_urls = ['https://www.teamrankings.com/nba/stat/fastbreak-points-per-game?date=2017-06-13']
